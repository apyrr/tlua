...
const (
	...
	KindAssertsKeyword
	KindAnyKeyword
	KindSuspendKeyword // out of alphabetical order on purpose: renamed from AsyncKeyword in place so the Kind value stays put
	KindBooleanKeyword
	KindConstKeyword // never produced by the scanner: `const` is an ordinary identifier; the parser synthesizes this kind for the const type-parameter modifier (`<const T>`)
...
type (
	...
	ModifierSyntaxKind             = Kind // KindAbstractKeyword | KindAccessorKeyword | KindSuspendKeyword | KindConstKeyword | KindDeclareKeyword | KindDefaultKeyword | KindExportKeyword | KindInKeyword | KindPrivateKeyword | KindProtectedKeyword | KindPublicKeyword | KindReadonlyKeyword | KindOutKeyword | KindOverrideKeyword | KindStaticKeyword
