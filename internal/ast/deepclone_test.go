...
func TestDeepCloneNodeSanityCheck(t *testing.T) {
	...
	data := []struct {
		...
		{title: "FunctionExpression#4", input: `(suspend function f(){})`},
		{title: "FunctionExpression#5", input: `(suspend function*f(){})`},
		...
		{title: "ArrowFunction#5", input: `suspend a=>{}`},
		{title: "ArrowFunction#6", input: `suspend()=>{}`},
		{title: "ArrowFunction#7", input: `suspend<T>()=>{}`},
		...
		{title: "Block", input: `{}`},
		{title: "VariableStatement#1", input: `local a`},
		{title: "VariableStatement#2", input: `local a`},
		{title: "VariableStatement#3", input: `local a = b`},
		...
		{title: "ForStatement#3", input: `for(local a;;);`},
		...
		{title: "FunctionDeclaration#4", input: `suspend function f(){}`},
		{title: "FunctionDeclaration#5", input: `suspend function*f(){}`},
		...
		{title: "MethodDeclaration#15", input: "class C {suspend a() {} }"},
