...
func IsKeywordTypeNode(node *Node) bool {
	switch node.Kind {
	case KindAnyKeyword, KindBooleanKeyword, KindFunctionKeyword, KindIntrinsicKeyword, KindNeverKeyword, KindNumberKeyword, KindObjectKeyword, KindThreadKeyword, KindUserdataKeyword, KindCDataKeyword, KindStringKeyword, KindSymbolKeyword, KindNilKeyword, KindUnknownKeyword, KindVoidKeyword:
		return true
	}
	return false
}
