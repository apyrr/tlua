...
func TestGetPackageRealpathFuncs_FollowsNodeModulesSymlinks(t *testing.T) {
	...
	// the node_modules symlink so that /real/bin/pkg/node_modules/dep/index.d.tlua
	// resolves to /real/dep/index.d.tlua — otherwise the same dep file gets different
	...
	fs := vfstest.FromMap(map[string]any{
		...
		"/real/bin/pkg/index.d.tlua":        "export declare local a: number;",
		"/real/bin/pkg/node_modules/dep":    vfstest.Symlink("/real/dep"),
		"/real/dep/index.d.tlua":            "export declare local b: number;",
		"/real/dep/src/utils/helper.d.tlua": "export declare local c: number;",
	}, true)
	...
	assert.Equal(
		t,
		toRealpath("/symlink-bin/pkg/index.d.tlua"),
		"/real/bin/pkg/index.d.tlua",
	...
	assert.Equal(
		t,
		toRealpath("/real/bin/pkg/node_modules/dep/index.d.tlua"),
		"/real/dep/index.d.tlua",
	...
	assert.Equal(
		t,
		toRealpath("/real/bin/pkg/node_modules/dep/src/utils/helper.d.tlua"),
		"/real/dep/src/utils/helper.d.tlua",
...
func TestGetPackageRealpathFuncs_DuplicateCacheKeys(t *testing.T) {
	...
	fs := vfstest.FromMap(map[string]any{
		...
		"/store/app-a/index.d.tlua":            "export declare local a: number;",
		"/store/app-b/index.d.tlua":            "export declare local b: number;",
		...
		"/store/shared-lib/index.d.tlua":       "export declare local shared: string;",
	}, true)
	...
	sharedFileViaA := "/store/app-a/node_modules/shared-lib/index.d.tlua"
	sharedFileViaB := "/store/app-b/node_modules/shared-lib/index.d.tlua"
	...
	expectedRealpath := "/store/shared-lib/index.d.tlua"
...
func TestGetPackageRealpathFuncs_NonSymlinkedPackageWithSymlinkedDeps(t *testing.T) {
	...
	fs := vfstest.FromMap(map[string]any{
		"/real/my-pkg/index.d.tlua":     "export declare local a: number;",
	...
	assert.Equal(
		t,
		toRealpath("/real/my-pkg/index.d.tlua"),
		"/real/my-pkg/index.d.tlua",
	)

	// Files outside the package reached via symlinked node_modules should still be resolved.
	assert.Equal(
		t,
		toRealpath("/real/my-pkg/node_modules/dep/index.d.tlua"),
		"/real/dep/index.d.tlua",
