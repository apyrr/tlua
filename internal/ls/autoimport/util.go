...
import (
	...
	"github.com/apyrr/tlua/internal/vfs/wrapvfs"
)
...
func getResolvedPackageNames(ctx context.Context, program *compiler.Program) *collections.Set[string] {
	...
	// String-named ambient modules are deleted, so unresolved package names can
	// no longer be satisfied by an ambient module declaration.
