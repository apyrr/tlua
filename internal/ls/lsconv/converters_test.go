...
func TestDocumentURIToFileName(t *testing.T) {
	...
	tests := []struct {
		...
		{"file:///path/to/file.tlua", "/path/to/file.tlua"},
		{"file://server/share/file.tlua", "//server/share/file.tlua"},
		{"file:///d%3A/work/tlua932/lib/utils.tlua", "d:/work/tlua932/lib/utils.tlua"},
		{"file:///D%3A/work/tlua932/lib/utils.tlua", "d:/work/tlua932/lib/utils.tlua"},
		{"file:///d%3A/work/tlua932/app/%28test%29/comp/comp-test.tsx", "d:/work/tlua932/app/(test)/comp/comp-test.tsx"},
		{"file:///path/to/file.tlua#section", "/path/to/file.tlua"},
		...
		{"untitled:C:/Users/jrieken/Code/abc.txt", "^/untitled/ts-nul-authority/C:/Users/jrieken/Code/abc.txt"},
		{"untitled://wsl%2Bubuntu/home/jabaile/work/TypeScript-go/newfile.tlua", "^/untitled/wsl%2Bubuntu/home/jabaile/work/TypeScript-go/newfile.tlua"},
	}
...
func TestFileNameToDocumentURI(t *testing.T) {
	...
	tests := []struct {
		...
		{"/path/to/file.tlua", "file:///path/to/file.tlua"},
		{"//server/share/file.tlua", "file://server/share/file.tlua"},
		{"d:/work/tlua932/lib/utils.tlua", "file:///d%3A/work/tlua932/lib/utils.tlua"},
		{"d:/work/tlua932/lib/utils.tlua", "file:///d%3A/work/tlua932/lib/utils.tlua"},
		{"d:/work/tlua932/app/(test)/comp/comp-test.tsx", "file:///d%3A/work/tlua932/app/%28test%29/comp/comp-test.tsx"},
		{"/path/to/file.tlua", "file:///path/to/file.tlua"},
		...
		{"^/untitled/ts-nul-authority///wsl%2Bubuntu/home/jabaile/work/TypeScript-go/newfile.tlua", "untitled://wsl%2Bubuntu/home/jabaile/work/TypeScript-go/newfile.tlua"},
	}
...
func newTestConverters(text string) (*lsconv.Converters, *testScript) {
	script := &testScript{name: "test.tlua", text: text}
...
// jsReferenceScript is a Node.lua script that, given a list of UTF-8 byte buffers,
...
// essentially what tsserver / sys.tlua does when reading file contents from disk
...
process.stdin.on('end', () => {
  ...
  const out = buffers.map(bytes => {
    // Decode the raw UTF-8 bytes to a JS string (this is what sys.tlua does with file contents).
...
// authoritative results computed by Node.lua using real UTF-16 string semantics.
