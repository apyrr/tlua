...
var X_0_is_not_a_valid_tlua_operator_Use_1_instead = &Message{code: 100020, category: CategoryError, key: "_0_is_not_a_valid_tlua_operator_Use_1_instead_100020", text: "'{0}' is not a valid tlua operator. Use '{1}' instead."}

var A_type_predicate_cannot_be_part_of_a_multiple_return_type = &Message{code: 100021, category: CategoryError, key: "A_type_predicate_cannot_be_part_of_a_multiple_return_type_100021", text: "A type predicate cannot be part of a multiple return type."}
...
var Cannot_jump_into_the_scope_of_local_0 = &Message{code: 100026, category: CategoryError, key: "Cannot_jump_into_the_scope_of_local_0_100026", text: "Cannot jump into the scope of local '{0}'."}

var A_label_cannot_appear_in_a_single_statement_context = &Message{code: 100027, category: CategoryError, key: "A_label_cannot_appear_in_a_single_statement_context_100027", text: "A label cannot appear in a single-statement context."}

var An_arithmetic_operand_must_be_of_type_any_or_number = &Message{code: 100028, category: CategoryError, key: "An_arithmetic_operand_must_be_of_type_any_or_number_100028", text: "An arithmetic operand must be of type 'any' or 'number'."}

var The_left_hand_side_of_an_arithmetic_operation_must_be_of_type_any_or_number = &Message{code: 100029, category: CategoryError, key: "The_left_hand_side_of_an_arithmetic_operation_must_be_of_type_any_or_number_100029", text: "The left-hand side of an arithmetic operation must be of type 'any' or 'number'."}

var The_right_hand_side_of_an_arithmetic_operation_must_be_of_type_any_or_number = &Message{code: 100030, category: CategoryError, key: "The_right_hand_side_of_an_arithmetic_operation_must_be_of_type_any_or_number_100030", text: "The right-hand side of an arithmetic operation must be of type 'any' or 'number'."}

var A_const_assertion_can_only_be_applied_to_string_number_boolean_array_or_object_literals = &Message{code: 100031, category: CategoryError, key: "A_const_assertion_can_only_be_applied_to_string_number_boolean_array_or_object_literals_100031", text: "A 'const' assertion can only be applied to string, number, boolean, array, or object literals."}

var A_const_initializer_in_an_ambient_context_must_be_a_string_numeric_or_boolean_literal = &Message{code: 100032, category: CategoryError, key: "A_const_initializer_in_an_ambient_context_must_be_a_string_numeric_or_boolean_literal_100032", text: "A 'const' initializer in an ambient context must be a string, numeric, or boolean literal."}

var Multiple_return_types_must_be_parenthesized = &Message{code: 100033, category: CategoryError, key: "Multiple_return_types_must_be_parenthesized_100033", text: "Multiple return types must be parenthesized."}

var A_vararg_parameter_cannot_have_a_name = &Message{code: 100034, category: CategoryError, key: "A_vararg_parameter_cannot_have_a_name_100034", text: "A vararg parameter cannot have a name."}

var A_expression_is_only_allowed_inside_a_vararg_function = &Message{code: 100035, category: CategoryError, key: "A_expression_is_only_allowed_inside_a_vararg_function_100035", text: "A '...' expression is only allowed inside a vararg function."}

var An_index_signature_parameter_type_cannot_be_a_literal_type_Consider_using_a_mapped_object_type_instead = &Message{code: 100036, category: CategoryError, key: "An_index_signature_parameter_type_cannot_be_a_literal_type_Consider_using_a_mapped_object_type_inste_100036", text: "An index signature parameter type cannot be a literal type. Consider using a mapped object type instead."}

var Expected_at_most_0_arguments_but_a_tail_may_pass_more = &Message{code: 100037, category: CategoryError, key: "Expected_at_most_0_arguments_but_a_tail_may_pass_more_100037", text: "Expected at most {0} arguments, but a tail may pass more."}

var A_multiple_return_type_cannot_be_used_as_a_value_type = &Message{code: 100038, category: CategoryError, key: "A_multiple_return_type_cannot_be_used_as_a_value_type_100038", text: "A multiple return type cannot be used as a value type."}

var An_index_signature_parameter_type_cannot_include_nil = &Message{code: 100039, category: CategoryError, key: "An_index_signature_parameter_type_cannot_include_nil_100039", text: "An index signature parameter type cannot include 'nil'."}

var A_table_key_cannot_be_nil = &Message{code: 100040, category: CategoryError, key: "A_table_key_cannot_be_nil_100040", text: "A table key cannot be 'nil'."}

var Cannot_change_a_protected_metatable = &Message{code: 100041, category: CategoryError, key: "Cannot_change_a_protected_metatable_100041", text: "Cannot change a protected metatable."}

var The_operator_can_only_be_applied_to_a_string_or_a_table = &Message{code: 100042, category: CategoryError, key: "The_operator_can_only_be_applied_to_a_string_or_a_table_100042", text: "The '#' operator can only be applied to a string or a table."}

var A_generic_type_parameter_cannot_follow_a_generic_pack_parameter = &Message{code: 100043, category: CategoryError, key: "A_generic_type_parameter_cannot_follow_a_generic_pack_parameter_100043", text: "A generic type parameter cannot follow a generic pack parameter."}

var A_generic_pack_parameter_can_only_be_used_in_a_vararg_parameter_or_a_multiple_return_position = &Message{code: 100044, category: CategoryError, key: "A_generic_pack_parameter_can_only_be_used_in_a_vararg_parameter_or_a_multiple_return_position_100044", text: "A generic pack parameter can only be used in a vararg parameter or a multiple-return position."}

var A_generic_pack_parameter_is_only_allowed_on_a_function_or_a_type_alias = &Message{code: 100045, category: CategoryError, key: "A_generic_pack_parameter_is_only_allowed_on_a_function_or_a_type_alias_100045", text: "A generic pack parameter is only allowed on a function or a type alias."}

var A_generic_pack_parameter_cannot_have_a_constraint_or_a_default = &Message{code: 100046, category: CategoryError, key: "A_generic_pack_parameter_cannot_have_a_constraint_or_a_default_100046", text: "A generic pack parameter cannot have a constraint or a default."}

var A_generic_pack_argument_can_only_be_supplied_for_a_generic_pack_parameter = &Message{code: 100047, category: CategoryError, key: "A_generic_pack_argument_can_only_be_supplied_for_a_generic_pack_parameter_100047", text: "A generic pack argument can only be supplied for a generic pack parameter."}
...
func keyToMessage(key Key) *Message {
	...
	case "_0_is_not_a_valid_tlua_operator_Use_1_instead_100020":
		return X_0_is_not_a_valid_tlua_operator_Use_1_instead
	case "A_type_predicate_cannot_be_part_of_a_multiple_return_type_100021":
	...
	case "Cannot_jump_into_the_scope_of_local_0_100026":
		return Cannot_jump_into_the_scope_of_local_0
	case "A_label_cannot_appear_in_a_single_statement_context_100027":
		return A_label_cannot_appear_in_a_single_statement_context
	case "An_arithmetic_operand_must_be_of_type_any_or_number_100028":
		return An_arithmetic_operand_must_be_of_type_any_or_number
	case "The_left_hand_side_of_an_arithmetic_operation_must_be_of_type_any_or_number_100029":
		return The_left_hand_side_of_an_arithmetic_operation_must_be_of_type_any_or_number
	case "The_right_hand_side_of_an_arithmetic_operation_must_be_of_type_any_or_number_100030":
		return The_right_hand_side_of_an_arithmetic_operation_must_be_of_type_any_or_number
	case "A_const_assertion_can_only_be_applied_to_string_number_boolean_array_or_object_literals_100031":
		return A_const_assertion_can_only_be_applied_to_string_number_boolean_array_or_object_literals
	case "A_const_initializer_in_an_ambient_context_must_be_a_string_numeric_or_boolean_literal_100032":
		return A_const_initializer_in_an_ambient_context_must_be_a_string_numeric_or_boolean_literal
	case "Multiple_return_types_must_be_parenthesized_100033":
		return Multiple_return_types_must_be_parenthesized
	case "A_vararg_parameter_cannot_have_a_name_100034":
		return A_vararg_parameter_cannot_have_a_name
	case "A_expression_is_only_allowed_inside_a_vararg_function_100035":
		return A_expression_is_only_allowed_inside_a_vararg_function
	case "An_index_signature_parameter_type_cannot_be_a_literal_type_Consider_using_a_mapped_object_type_inste_100036":
		return An_index_signature_parameter_type_cannot_be_a_literal_type_Consider_using_a_mapped_object_type_instead
	case "Expected_at_most_0_arguments_but_a_tail_may_pass_more_100037":
		return Expected_at_most_0_arguments_but_a_tail_may_pass_more
	case "A_multiple_return_type_cannot_be_used_as_a_value_type_100038":
		return A_multiple_return_type_cannot_be_used_as_a_value_type
	case "An_index_signature_parameter_type_cannot_include_nil_100039":
		return An_index_signature_parameter_type_cannot_include_nil
	case "A_table_key_cannot_be_nil_100040":
		return A_table_key_cannot_be_nil
	case "Cannot_change_a_protected_metatable_100041":
		return Cannot_change_a_protected_metatable
	case "The_operator_can_only_be_applied_to_a_string_or_a_table_100042":
		return The_operator_can_only_be_applied_to_a_string_or_a_table
	case "A_generic_type_parameter_cannot_follow_a_generic_pack_parameter_100043":
		return A_generic_type_parameter_cannot_follow_a_generic_pack_parameter
	case "A_generic_pack_parameter_can_only_be_used_in_a_vararg_parameter_or_a_multiple_return_position_100044":
		return A_generic_pack_parameter_can_only_be_used_in_a_vararg_parameter_or_a_multiple_return_position
	case "A_generic_pack_parameter_is_only_allowed_on_a_function_or_a_type_alias_100045":
		return A_generic_pack_parameter_is_only_allowed_on_a_function_or_a_type_alias
	case "A_generic_pack_parameter_cannot_have_a_constraint_or_a_default_100046":
		return A_generic_pack_parameter_cannot_have_a_constraint_or_a_default
	case "A_generic_pack_argument_can_only_be_supplied_for_a_generic_pack_parameter_100047":
