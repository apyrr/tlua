...
import (
	...
	"github.com/apyrr/tlua/internal/testutil/tsbaseline"
...
func compilerBaselineHeader(filename string) string {
	headerComponents := tspath.GetPathComponentsRelativeTo(repo.TestDataPath(), filename, tspath.ComparePathsOptions{})
	return tspath.GetPathFromPathComponents(headerComponents)
}
...
func (c *compilerTest) verifyJavaScriptOutput(t *testing.T, suiteName string) {
	...
	t.Run("output", func(t *testing.T) {
		...
		header := compilerBaselineHeader(c.filename)
