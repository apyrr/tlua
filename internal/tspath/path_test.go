...
var getNormalizedAbsolutePathTests = map[string][][]string{
	...
	"normalized inputs": {
		{"/a/b", ""},
		{"/one/two/three", ""},
		{"/users/root/project/src/foo.tlua", ""},
	},
...
func TestToFileNameLowerCase(t *testing.T) {
	t.Parallel()
	assert.Equal(t, ToFileNameLowerCase("/user/UserName/projects/Project/file.tlua"), "/user/username/projects/project/file.tlua")
	assert.Equal(t, ToFileNameLowerCase("/user/UserName/projects/projectß/file.tlua"), "/user/username/projects/projectß/file.tlua")
	assert.Equal(t, ToFileNameLowerCase("/user/UserName/projects/İproject/file.tlua"), "/user/username/projects/İproject/file.tlua")
	assert.Equal(t, ToFileNameLowerCase("/user/UserName/projects/ı/file.tlua"), "/user/username/projects/ı/file.tlua")
}
...
var toFileNameLowerCaseTests = []string{
	...
	"/PATH/TO/FILE.EXT",
	"/path/to/FILE.EXT",
	"/user/UserName/projects/Project/file.tlua",
	"/user/UserName/projects/projectß/file.tlua",
	"/user/UserName/projects/İproject/file.tlua",
	"/user/UserName/projects/ı/file.tlua",
