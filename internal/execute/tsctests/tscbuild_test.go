	...
	testCases := []*tscInput{
		...
		},
		{
			...
			files: FileMap{
				...
				"/user/username/projects/project/tsconfig.json": `{"compilerOptions":{"composite":true,"outDir":"dist"},"files":["src/a.tlua","src/b.tlua"]}`,
...
func TestBuildProjectsBuilding(t *testing.T) {
	...
	getTestCases := func(pkgCount int, builders int) []*tscInput {
		getEdits := func(watch bool) []*tscEdit {
...
func TestBuildRoots(t *testing.T) {
	...
	getBuildRootsFromProjectReferencedProjectTestEdits := func(watch bool) []*tscEdit {
...
/// <reference lib="esnext" />`
				files[tscLibPath+"/lib.d.tlua"] = `/// <reference no-default-lib="true"/>
/// <reference lib="esnext" />`
				files["/user/username/projects/sample1/core/tsconfig.json"] = stringtestutil.Dedent(`
				{
					"compilerOptions": {
