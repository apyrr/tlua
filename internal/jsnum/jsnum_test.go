...
// evalBinaryOp evaluates a binary JS expression on all cases using Node.lua.
// Skips the calling test if Node.lua is not available.
...
// evalUnaryOp evaluates a unary JS expression on all cases using Node.lua.
// Skips the calling test if Node.lua is not available.
