...
func TestGetPathComponentsForWatching(t *testing.T) {
	...
	assert.DeepEqual(t, getPathComponentsForWatching("//server/share/project/tluaconfig.json", ""), []string{"//server/share", "project", "tluaconfig.json"})
	assert.DeepEqual(t, getPathComponentsForWatching(`\\server\share\project\tluaconfig.json`, ""), []string{"//server/share", "project", "tluaconfig.json"})
