...
func TestUpdateWatchTimeoutAndRollback(t *testing.T) {
	...
	t.Run("watch retries on next snapshot update after timeout with same watcher identity", func(t *testing.T) {
		...
		synctest.Test(t, func(t *testing.T) {
			...
			uri := lsproto.DocumentUri("file:///home/projects/TS/p1/src/index.tlua")
			...
			session.DidOpenFile(context.Background(), uri, 1, files["/home/projects/TS/p1/src/index.tlua"].(string), lsproto.LanguageKindTypeScript)
