...
/*1*/local _ = (i=i+1,i=i+1);
/*2*/local _ = (i=i+1,i=i+1);
/*3*/local _ = (1,2);
/*4*/local _ = (i=i+1,2);
/*5*/local _ = (i=i+1,i=i+1,i=i+1,i=i-1,2);
local s = 'foo';
/*6*/for (local i = 0,ii = 2; i < s.length; ii=ii+1,i=i+1) {
	...
	f.FormatDocument(t, "")
	f.GoToMarker(t, "1")
	f.VerifyCurrentLineContent(t, `local _ = (i = i + 1, i = i + 1);`)
	f.GoToMarker(t, "2")
	f.VerifyCurrentLineContent(t, `local _ = (i = i + 1, i = i + 1);`)
	f.GoToMarker(t, "3")
	f.VerifyCurrentLineContent(t, `local _ = (1, 2);`)
	f.GoToMarker(t, "4")
	f.VerifyCurrentLineContent(t, `local _ = (i = i + 1, 2);`)
	f.GoToMarker(t, "5")
	f.VerifyCurrentLineContent(t, `local _ = (i = i + 1, i = i + 1, i = i + 1, i = i - 1, 2);`)
	f.GoToMarker(t, "6")
