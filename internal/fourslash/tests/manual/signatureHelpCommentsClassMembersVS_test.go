...
local i1_p = i1.p1;
local i1_f = i1.p2;
local i1_r = i1.p2(/*71*/20);
local i1_prop = i1.p3;
i1.p3 = i1_prop;
local i1_nc_p = i1.nc_p1;
local i1_ncf = i1.nc_p2;
local i1_ncr = i1.nc_p2(/*81*/20);
local i1_ncprop = i1.nc_p3;
i1.nc_p3 = i1_ncprop;
local i1_s_p = c1.s1;
local i1_s_f = c1.s2;
local i1_s_r = c1.s2(/*92*/20);
local i1_s_prop = c1.s3;
c1.s3 = i1_s_prop;
local i1_s_nc_p = c1.nc_s1;
local i1_s_ncf = c1.nc_s2;
local i1_s_ncr = c1.nc_s2(/*102*/20);
local i1_s_ncprop = c1.nc_s3;
...
local cProperties_i = new cProperties();
