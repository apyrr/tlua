...
function Baz<T extends {b: number}, U extends {a: boolean, b:string}>(arg1: T, arg2: U) {
    local a0 = <Overloa/*1*/dComponent {...arg1} a="hello" ignore-prop />;
    local a1 = <Overloa/*2*/dComponent {...arg2} ignore-pro="hello world" />;
    local a2 = <Overloa/*3*/dComponent {...arg2} />;
    local a3 = <Overloa/*4*/dComponent {...arg1} ignore-prop />;
    local a4 = <Overloa/*5*/dComponent />;
    local a5 = <Overloa/*6*/dComponent {...arg2} ignore-prop="hello" {...arg1} />;
    local a6 = <Overloa/*7*/dComponent {...arg1} ignore-prop {...arg2} />;
}`
