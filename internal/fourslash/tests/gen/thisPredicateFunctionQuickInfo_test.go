...
local a: RoyalGuard = new FollowerGuard();
if (a.is/*1*/Leader()) {
    a./*2*/;
}
...
local checked/*14*/LeaderStatus = isLeader/*15*/Guard(a);`
	...
	f.VerifyQuickInfoAt(t, "13", "local leaderStatus: boolean", "")
	f.VerifyQuickInfoAt(t, "14", "local checkedLeaderStatus: boolean", "")
