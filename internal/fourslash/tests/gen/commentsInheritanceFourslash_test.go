...
local c/*17iq*/2_i = new c/*17q*/2(/*17*/10);
local c/*18iq*/3_i = new c/*18q*/3(/*18*/);
...
local c4/*34iq*/_i = new c/*34q*/4(/*34*/10);
/*35*/
interface i2 {
    /** i2_p1*/
    i2_p1: number;
...
class c6 extends c5 {
	...
	f.GoToMarker(t, "l5")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: ""})
	f.VerifyQuickInfoAt(t, "1iq", "local i1_i: i1", "")
	...
	f.GoToMarker(t, "l8")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: ""})
	f.VerifyQuickInfoAt(t, "6iq", "local c1_i: c1", "")
	...
	f.VerifyQuickInfoAt(t, "17iq", "local c2_i: c2", "")
	f.VerifyQuickInfoAt(t, "18iq", "local c3_i: c3", "")
	f.GoToMarker(t, "17")
	...
	f.GoToMarker(t, "34")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: "c2 constructor"})
	f.VerifyQuickInfoAt(t, "34iq", "local c4_i: c4", "")
	...
	f.GoToMarker(t, "l40")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: ""})
	f.VerifyQuickInfoAt(t, "36iq", "local i2_i: i2", "")
	f.VerifyQuickInfoAt(t, "37iq", "local i3_i: i3", "")
