...
class Foo {
	...
	f.VerifyQuickInfoAt(t, "4", "local s: string | undefined", "")
	f.VerifyQuickInfoAt(t, "5", "local s: string | undefined", "")
	f.VerifyQuickInfoAt(t, "6", "local s: string", "")
	...
	f.VerifyCompletions(t, []string{"4", "5"}, &fourslash.CompletionsExpectedList{
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:  "s",
					Detail: new("local s: string | undefined"),
				},
			},
		},
	})
