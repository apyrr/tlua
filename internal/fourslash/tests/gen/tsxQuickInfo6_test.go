...
function Bar<T extends {prop: number}>(arg: T) {
    local a1 = <Compone/*1*/ntSpecific {...arg} ignore-prop="hi" />;  // U is number
    local a2 = <ComponentSpecific1 {...arg} ignore-prop={10} />;  // U is number
    local a3 = <Component/*2*/Specific {...arg} prop="hello" />;   // U is "hello"
}`
