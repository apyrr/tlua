...
local c1/*66*/_i_1 = new c/*55q*/1(/*55*/10);
local c1_i_2 = new c/*56q*/1(/*56*/"hello");
local c2_i_1 = new c/*57q*/2(/*57*/10);
local c/*67*/2_i_2 = new c/*58q*/2(/*58*/"hello");
local c3_i_1 = new c/*59q*/3(/*59*/10);
local c/*68*/3_i_2 = new c/*60q*/3(/*60*/"hello");
local c4/*69*/_i_1 = new c/*61q*/4(/*61*/10);
local c4_i_2 = new c/*62q*/4(/*62*/"hello");
local c/*70*/5_i_1 = new c/*63q*/5(/*63*/10);
local c5_i_2 = new c/*64q*/5(/*64*/"hello");
...
foo(null);`
	...
	f.VerifyQuickInfoAt(t, "32q", "local i2_i: i2\nnew (b: number) => any (+1 overload)", "new 2")
	f.GoToMarker(t, "33")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "33q", "local i2_i: i2\nnew (a: string) => any (+1 overload)", "")
	f.GoToMarker(t, "34")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "34q", "local i2_i: i2\n(a: number) => number (+1 overload)", "")
	f.GoToMarker(t, "35")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: "this is signature 2", OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "35q", "local i2_i: i2\n(b: string) => number (+1 overload)", "this is signature 2")
	f.GoToMarker(t, "36")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: "new 2", OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "36q", "local i3_i: i3\nnew (b: number) => any (+1 overload)", "new 2")
	f.GoToMarker(t, "37")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: "new 1", OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "37q", "local i3_i: i3\nnew (a: string) => any (+1 overload)", "new 1")
	f.GoToMarker(t, "38")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: "this is signature 1", OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "38q", "local i3_i: i3\n(a: number) => number (+1 overload)", "this is signature 1")
	f.GoToMarker(t, "39")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "39q", "local i3_i: i3\n(b: string) => number (+1 overload)", "this is signature 1")
	f.GoToMarker(t, "40")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "40q", "local i4_i: i4\nnew (b: number) => any (+1 overload)", "")
	f.GoToMarker(t, "41")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "41q", "local i4_i: i4\nnew (a: string) => any (+1 overload)", "")
	f.GoToMarker(t, "42")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "42q", "local i4_i: i4\n(a: number) => number (+1 overload)", "")
	f.GoToMarker(t, "43")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{OverloadsCount: 2})
	f.VerifyQuickInfoAt(t, "43q", "local i4_i: i4\n(b: string) => number (+1 overload)", "")
	...
	f.VerifyCompletions(t, "65", &fourslash.CompletionsExpectedList{
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				...
				&lsproto.CompletionItem{
					Label:  "c_i",
					Detail: new("local c_i: c"),
				},
				&lsproto.CompletionItem{
					Label:  "c1_i_1",
					Detail: new("local c1_i_1: c1"),
				},
				&lsproto.CompletionItem{
					Label:  "c2_i_1",
					Detail: new("local c2_i_1: c2"),
				},
				&lsproto.CompletionItem{
					Label:  "c3_i_1",
					Detail: new("local c3_i_1: c3"),
				},
				&lsproto.CompletionItem{
					Label:  "c4_i_1",
					Detail: new("local c4_i_1: c4"),
				},
				&lsproto.CompletionItem{
					Label:  "c5_i_1",
					Detail: new("local c5_i_1: c5"),
				},
				&lsproto.CompletionItem{
					Label:  "c1_i_2",
					Detail: new("local c1_i_2: c1"),
				},
				&lsproto.CompletionItem{
					Label:  "c2_i_2",
					Detail: new("local c2_i_2: c2"),
				},
				&lsproto.CompletionItem{
					Label:  "c3_i_2",
					Detail: new("local c3_i_2: c3"),
				},
				&lsproto.CompletionItem{
					Label:  "c4_i_2",
					Detail: new("local c4_i_2: c4"),
				},
				&lsproto.CompletionItem{
					Label:  "c5_i_2",
					Detail: new("local c5_i_2: c5"),
				},
				&lsproto.CompletionItem{
					Label:  "multiOverload",
	...
	f.VerifyQuickInfoAt(t, "66", "local c1_i_1: c1", "")
	f.VerifyQuickInfoAt(t, "67", "local c2_i_2: c2", "")
	f.VerifyQuickInfoAt(t, "68", "local c3_i_2: c3", "")
	f.VerifyQuickInfoAt(t, "69", "local c4_i_1: c4", "")
	f.VerifyQuickInfoAt(t, "70", "local c5_i_1: c5", "")
