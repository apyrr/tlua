...
local i2/*6*/_i: /*34i*/i2;
local i2_i/*7*/_x = i2_i./*8*/x;
local i2_i/*9*/_foo = i2_i.f/*10*/oo;
local i2_i_f/*11*/oo_r = i2_i.f/*12q*/oo(/*12*/30);
local i2_i_i2_/*13*/si = i2/*13q*/_i["hello"];
local i2_i_i2/*14*/_ii = i2/*14q*/_i[30];
local i2_/*15*/i_n = new i2/*16q*/_i(/*16*/i1_i);
local i2_i/*17*/_nc_x = i2_i.n/*18*/c_x;
local i2_i_/*19*/nc_foo = i2_i.n/*20*/c_foo;
local i2_i_nc_f/*21*/oo_r = i2_i.nc/*22q*/_foo(/*22*/30);
local i2/*23*/_i_r = i2/*24q*/_i(/*24*/10, /*25*/20);
local i2_i/*26*/_fnfoo = i2_i.fn/*27*/foo;
local i2_i_/*28*/fnfoo_r = i2_i.fn/*29q*/foo(/*29*/10);
local i2_i/*30*/_nc_fnfoo = i2_i.nc_fn/*31*/foo;
local i2_i_nc_/*32*/fnfoo_r = i2_i.nc/*33q*/_fnfoo(/*33*/10);
/*34*/
interface i3 {
    /** Comment i3 x*/
    x: number;
...
i3_i.nc/*45q*/_l(/*45*/10);`
	...
	f.VerifyQuickInfoAt(t, "2", "local i1_i: i1", "")
	f.VerifyQuickInfoAt(t, "3", "interface nc_i1", "")
	f.VerifyQuickInfoAt(t, "4", "local nc_i1_i: nc_i1", "")
	f.VerifyQuickInfoAt(t, "5", "interface i2", "this is interface 2 with members")
	f.VerifyQuickInfoAt(t, "6", "local i2_i: i2", "")
	f.VerifyQuickInfoAt(t, "7", "local i2_i_x: number", "")
	...
	f.VerifyQuickInfoAt(t, "9", "local i2_i_foo: (b: number) => string", "")
	f.VerifyQuickInfoAt(t, "10", "(property) i2.foo: (b: number) => string", "this is foo")
	f.VerifyQuickInfoAt(t, "11", "local i2_i_foo_r: string", "")
	f.GoToMarker(t, "12")
	...
	f.VerifyQuickInfoAt(t, "13", "local i2_i_i2_si: number", "")
	f.VerifyQuickInfoAt(t, "13q", "local i2_i: i2", "")
	f.VerifyQuickInfoAt(t, "14", "local i2_i_i2_ii: number", "")
	f.VerifyQuickInfoAt(t, "14q", "local i2_i: i2", "")
	f.VerifyQuickInfoAt(t, "15", "local i2_i_n: any", "")
	f.GoToMarker(t, "16")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: "new method", ParameterDocComment: "param"})
	f.VerifyQuickInfoAt(t, "16q", "local i2_i: i2\nnew (i: i1) => any", "new method")
	f.VerifyQuickInfoAt(t, "17", "local i2_i_nc_x: number", "")
	f.VerifyQuickInfoAt(t, "18", "(property) i2.nc_x: number", "")
	f.VerifyQuickInfoAt(t, "19", "local i2_i_nc_foo: (b: number) => string", "")
	f.VerifyQuickInfoAt(t, "20", "(property) i2.nc_foo: (b: number) => string", "")
	f.VerifyQuickInfoAt(t, "21", "local i2_i_nc_foo_r: string", "")
	f.GoToMarker(t, "22")
	...
	f.VerifyQuickInfoAt(t, "23", "local i2_i_r: number", "")
	f.GoToMarker(t, "24")
	...
	f.VerifyQuickInfoAt(t, "26", "local i2_i_fnfoo: (b: number) => string", "")
	f.VerifyQuickInfoAt(t, "27", "(method) i2.fnfoo(b: number): string", "this is fnfoo")
	f.VerifyQuickInfoAt(t, "28", "local i2_i_fnfoo_r: string", "")
	f.GoToMarker(t, "29")
	...
	f.VerifyQuickInfoAt(t, "30", "local i2_i_nc_fnfoo: (b: number) => string", "")
	f.VerifyQuickInfoAt(t, "31", "(method) i2.nc_fnfoo(b: number): string", "")
	f.VerifyQuickInfoAt(t, "32", "local i2_i_nc_fnfoo_r: string", "")
	f.GoToMarker(t, "33")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{DocComment: ""})
	...
	f.VerifyCompletions(t, "34", &fourslash.CompletionsExpectedList{
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:  "i1_i",
					Detail: new("local i1_i: i1"),
				},
				&lsproto.CompletionItem{
					Label:  "nc_i1_i",
					Detail: new("local nc_i1_i: nc_i1"),
					Documentation: &lsproto.StringOrMarkupContent{
						MarkupContent: &lsproto.MarkupContent{
							Kind:  lsproto.MarkupKindMarkdown,
							Value: "",
				...
				&lsproto.CompletionItem{
					Label:  "i2_i",
					Detail: new("local i2_i: i2"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_x",
					Detail: new("local i2_i_x: number"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_foo",
					Detail: new("local i2_i_foo: (b: number) => string"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_foo_r",
					Detail: new("local i2_i_foo_r: string"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_i2_si",
					Detail: new("local i2_i_i2_si: number"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_i2_ii",
					Detail: new("local i2_i_i2_ii: number"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_n",
					Detail: new("local i2_i_n: any"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_nc_x",
					Detail: new("local i2_i_nc_x: number"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_nc_foo",
					Detail: new("local i2_i_nc_foo: (b: number) => string"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_nc_foo_r",
					Detail: new("local i2_i_nc_foo_r: string"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_r",
					Detail: new("local i2_i_r: number"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_fnfoo",
					Detail: new("local i2_i_fnfoo: (b: number) => string"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_fnfoo_r",
					Detail: new("local i2_i_fnfoo_r: string"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_nc_fnfoo",
					Detail: new("local i2_i_nc_fnfoo: (b: number) => string"),
				},
				&lsproto.CompletionItem{
					Label:  "i2_i_nc_fnfoo_r",
					Detail: new("local i2_i_nc_fnfoo_r: string"),
				},
			},
			Excludes: []string{
				"i1",
	...
	f.VerifyQuickInfoAt(t, "40q", "local i3_i: i3", "")
