...
local i/*64*/1 = new c/*65q*/1();
local i1/*66*/_p = i1.p1;
local i1/*68*/_f = i1.p/*69*/2;
local i1/*70*/_r = i1.p/*71q*/2(20);
local i1_p/*72*/rop = i1./*73*/p3;
i1./*74*/p3 = i1_/*75*/prop;
local i1_/*76*/nc_p = i1.n/*77*/c_p1;
local i1/*78*/_ncf = i1.nc_/*79*/p2;
local i1_/*80*/ncr = i1.nc/*81q*/_p2(20);
local i1_n/*82*/cprop = i1.n/*83*/c_p3;
i1.nc/*84*/_p3 = i1_/*85*/ncprop;
local i1_/*86*/s_p = /*87*/c1./*88*/s1;
local i1_s/*89*/_f = c1./*90*/s2;
local i1_/*91*/s_r = c1.s/*92q*/2(20);
local i1_s/*93*/_prop = c1.s/*94*/3;
c1.s/*95*/3 = i1_s/*96*/_prop;
local i1_s/*97*/_nc_p = c1.n/*98*/c_s1;
local i1_s_/*99*/ncf = c1.nc/*100*/_s2;
local i1_s_/*101*/ncr = c1.n/*102q*/c_s2(20);
local i1_s_n/*103*/cprop = c1.nc/*104*/_s3;
c1.nc/*105*/_s3 = i1_s_nc/*106*/prop;
local i1/*107*/_c = c/*108*/1;
