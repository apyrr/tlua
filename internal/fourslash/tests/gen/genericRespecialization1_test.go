...
local cookie = new Cookie("Chocolate Chip", false);
local cookieMonster = new GenericMonster<Cookie, string>("Cookie Monster", 50, true, cookie, "hello");
local sesameStreet = new GenericPlanet<GenericMonster<Cookie, string>>("Sesame Street", "Alpha Centuri", cookieMonster);
class GenericPlanet2<T extends Food, V>{
 ...
 /*1*/`
	...
	f.Insert(t, "any")
	f.VerifyNoErrors(t)
	f.InsertLine(t, "local narnia = new GenericPlanet2<Cookie, string>(")
}
