...
const IMPORT_FOURSLASH = `"github.com/apyrr/tlua/internal/fourslash"`;
const IMPORT_TESTUTIL = `"github.com/apyrr/tlua/internal/testutil"`;
const IMPORT_CORE = `"github.com/apyrr/tlua/internal/core"`;
const IMPORT_LS = `"github.com/apyrr/tlua/internal/ls"`;
const IMPORT_LSUTIL = `"github.com/apyrr/tlua/internal/ls/lsutil"`;
const IMPORT_LSPROTO = `"github.com/apyrr/tlua/internal/lsp/lsproto"`;
const IMPORT_UTIL = `. "github.com/apyrr/tlua/internal/fourslash/tests/util"`;
...
// Mirror the repo-wide fixture rename so regenerated tests stay consistent.
    ...
    files.forEach(file => {
        ...
        if (stat.isDirectory()) {
            ...
            try {
                ...
                const testContent = rewriteExtensions(generateGoTest(test, isServer));
