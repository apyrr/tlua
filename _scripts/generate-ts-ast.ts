 ...
 *   - _packages/tlua/src/ast/ast.generated.ts
 *   - _packages/tlua/src/ast/factory.generated.ts
 *   - _packages/tlua/src/ast/is.generated.ts
 *
...
function generateAstGenerated(): string {
    ...
    const header = `// Code generated by _scripts/generate-ts-ast.ts. DO NOT EDIT.
...
export default function main() {
    ...
    const factoryPath = path.join(ROOT, "_packages/tlua/src/ast/factory.generated.ts");
    const isGenPath = path.join(ROOT, "_packages/tlua/src/ast/is.generated.ts");
    const astGenPath = path.join(ROOT, "_packages/tlua/src/ast/ast.generated.ts");
    const visitorPath = path.join(ROOT, "_packages/tlua/src/ast/visitor.generated.ts");
