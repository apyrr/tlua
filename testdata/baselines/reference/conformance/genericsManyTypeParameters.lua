//// [tests/cases/conformance/ported/genericsManyTypeParameters.tlua] ////

//// [genericsManyTypeParameters.tlua]
-- ported from tests/cases/compiler/genericsManyTypeParameters.ts
-- dropped: @target: es2015 directive (tlua defaults to latest target)
-- dropped: the TypeScript array literal return was rewritten as a positional table constructor; tlua has no array literals.
...
//// [genericsManyTypeParameters.lua]
-- ported from tests/cases/compiler/genericsManyTypeParameters.ts
-- dropped: @target: es2015 directive (tlua defaults to latest target)
-- dropped: the TypeScript array literal return was rewritten as a positional table constructor; tlua has no array literals.
