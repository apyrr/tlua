...
Output::
[96msrc/struct.tlua[0m:[93m2[0m:[93m21[0m - [91merror[0m[90m TS1149: [0mFile name '/user/username/projects/myproject/node_modules/fp-ts/lib/struct.tlua' differs from already included file name '/user/username/projects/myproject/node_modules/fp-ts/lib/Struct.tlua' only in casing.
...
[96msrc/struct.tlua[0m:[93m3[0m:[93m21[0m - [91merror[0m[90m TS1149: [0mFile name '/user/username/projects/myproject/src/Struct.tlua' differs from already included file name '/user/username/projects/myproject/src/struct.tlua' only in casing.
  The file is in the program because:
...
[96msrc/struct.tlua[0m:[93m4[0m:[93m21[0m - [91merror[0m[90m TS100055: [0mModule name 'struct' resolves to the same file as 'Struct'; a module has one canonical name.
