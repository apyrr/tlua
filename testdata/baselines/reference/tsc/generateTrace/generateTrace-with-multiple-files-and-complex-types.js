...
Output::
[96mmain.tlua[0m:[93m1[0m:[93m37[0m - [91merror[0m[90m TS1005: [0m',' expected.

[7m1[0m local c: Container<number> = { value: 42, map: (fn) => ({ value: fn(42), map: c.map }) };
[7m [0m [91m                                    ~[0m

[96mmain.tlua[0m:[93m1[0m:[93m46[0m - [91merror[0m[90m TS1005: [0m',' expected.

[7m1[0m local c: Container<number> = { value: 42, map: (fn) => ({ value: fn(42), map: c.map }) };
[7m [0m [91m                                             ~[0m

[96mmain.tlua[0m:[93m1[0m:[93m77[0m - [91merror[0m[90m TS1005: [0m',' expected.
