...
//// [/home/src/workspaces/solution/projects/server/tluaconfig.json] *new* 
{
    ...
    "include": [ "../shared/src/**/*.tlua", "src/**/*.tlua" ],
    "references": [
        { "path": "../shared" },
    ],
}
...
tlua --b projects/server -v --traceResolution --explainFiles
ExitStatus:: DiagnosticsPresent_OutputsSkipped
Output::
[[90mHH:MM:SS AM[0m] Projects in this build: 
    * projects/shared/tluaconfig.json
    * projects/server/tluaconfig.json

[[90mHH:MM:SS AM[0m] Project 'projects/shared/tluaconfig.json' is out of date because output file 'projects/shared/dist/tluaconfig.tluabuildinfo' does not exist

[[90mHH:MM:SS AM[0m] Building project 'projects/shared/tluaconfig.json'...
...
projects/shared/src/logging.tlua
   Matched by include pattern 'src/**/*.tlua' in 'projects/shared/tluaconfig.json'
projects/shared/src/myClass.tlua
   Matched by include pattern 'src/**/*.tlua' in 'projects/shared/tluaconfig.json'
projects/shared/src/random.tlua
   Matched by include pattern 'src/**/*.tlua' in 'projects/shared/tluaconfig.json'
[[90mHH:MM:SS AM[0m] Project 'projects/server/tluaconfig.json' is out of date because output file 'projects/server/dist/server/tluaconfig.tluabuildinfo' does not exist

[[90mHH:MM:SS AM[0m] Building project 'projects/server/tluaconfig.json'...
...
projects/server/src/server.tlua
   Matched by include pattern 'src/**/*.tlua' in 'projects/server/tluaconfig.json'

Found 4 errors in 4 files.

Errors  Files
     1  projects/server/src/server.tlua[90m:1[0m
     1  projects/shared/src/logging.tlua[90m:1[0m
     1  projects/shared/src/myClass.tlua[90m:1[0m
     1  projects/shared/src/random.tlua[90m:1[0m
...
//// [/home/src/workspaces/solution/projects/server/dist/server/tluaconfig.tluabuildinfo] *new* 
...
//// [/home/src/workspaces/solution/projects/server/dist/server/tluaconfig.tluabuildinfo.readable.baseline.txt] *new* 
{
...
[[90mHH:MM:SS AM[0m] Project 'projects/shared/tluaconfig.json' is out of date because buildinfo file 'projects/shared/dist/tluaconfig.tluabuildinfo' indicates that program needs to report errors.
...
projects/shared/src/random.tlua
   Matched by include pattern 'src/**/*.tlua' in 'projects/shared/tluaconfig.json'
[[90mHH:MM:SS AM[0m] Project 'projects/server/tluaconfig.json' is out of date because buildinfo file 'projects/server/dist/server/tluaconfig.tluabuildinfo' indicates that program needs to report errors.
