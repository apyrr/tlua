...
local b = 0;
return { b = b };
//// [/home/src/workspaces/solution/src/main/tluaconfig.main.json] *new* 
{
...
local Other = 0;
//// [/home/src/workspaces/solution/src/other/tluaconfig.other.json] *new* 
{
    "compilerOptions": { "composite": true, "outDir": "../../dist/" },
}
...
tlua --b src/main/tluaconfig.main.json --verbose
ExitStatus:: DiagnosticsPresent_OutputsSkipped
Output::
[[90mHH:MM:SS AM[0m] Projects in this build: 
    * src/other/tluaconfig.other.json
    * src/main/tluaconfig.main.json

[[90mHH:MM:SS AM[0m] Project 'src/other/tluaconfig.other.json' is out of date because output file 'dist/tluaconfig.other.tluabuildinfo' does not exist

[[90mHH:MM:SS AM[0m] Building project 'src/other/tluaconfig.other.json'...
...
[[90mHH:MM:SS AM[0m] Project 'src/main/tluaconfig.main.json' is out of date because output file 'dist/tluaconfig.main.tluabuildinfo' does not exist

[[90mHH:MM:SS AM[0m] Building project 'src/main/tluaconfig.main.json'...
...
//// [/home/src/workspaces/solution/dist/tluaconfig.main.tluabuildinfo] *new* 
...
//// [/home/src/workspaces/solution/dist/tluaconfig.main.tluabuildinfo.readable.baseline.txt] *new* 
{
...
//// [/home/src/workspaces/solution/dist/tluaconfig.other.tluabuildinfo] *new* 
...
//// [/home/src/workspaces/solution/dist/tluaconfig.other.tluabuildinfo.readable.baseline.txt] *new* 
{
  "version": "FakeTSVersion",
  "root": [
    {
...
[[90mHH:MM:SS AM[0m] Project 'src/other/tluaconfig.other.json' is out of date because buildinfo file 'dist/tluaconfig.other.tluabuildinfo' indicates that program needs to report errors.
...
[[90mHH:MM:SS AM[0m] Project 'src/main/tluaconfig.main.json' is out of date because buildinfo file 'dist/tluaconfig.main.tluabuildinfo' indicates that program needs to report errors.
