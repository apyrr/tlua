...
Input::
//// [/user/username/projects/project/dist/tluaconfig.tluabuildinfo] *new* 
{
...
local b = 2;
//// [/user/username/projects/project/tluaconfig.json] *new* 
...
[[90mHH:MM:SS AM[0m] Project 'tluaconfig.json' is out of date because output 'dist/tluaconfig.tluabuildinfo' is older than input 'src/a.tlua'

[[90mHH:MM:SS AM[0m] Building project 'tluaconfig.json'...

[96msrc/a.tlua[0m:[93m1[0m:[93m1[0m - [91merror[0m[90m TLUA100054: [0mDeclaration emit is not supported for a Lua module yet.

[7m1[0m local a = 1;
[7m [0m [91m~~~~~[0m

[96msrc/b.tlua[0m:[93m1[0m:[93m1[0m - [91merror[0m[90m TLUA100054: [0mDeclaration emit is not supported for a Lua module yet.
...
//// [/user/username/projects/project/dist/tluaconfig.tluabuildinfo] *modified* 
...
//// [/user/username/projects/project/dist/tluaconfig.tluabuildinfo.readable.baseline.txt] *new* 
{
  "version": "FakeTSVersion",
  "root": [
    {
