...
local mod = require('core.anotherModule');
return { m = mod };
//// [/user/username/projects/sample1/tests/tluaconfig.base.json] *new* 
{
    "compilerOptions": {
        "target": "es5"
    }
...
{
    "extends": "./tluaconfig.base.json", "references": [
        { "path": "../core" },
        { "path": "../logic" },
    ],
    "files": ["index.tlua"],
...
[96mtests/tluaconfig.json[0m:[93m7[0m:[93m5[0m - [91merror[0m[90m TLUA5108: [0mOption 'target=ES5' has been removed. Please remove it from your configuration.

[7m7[0m     "compilerOptions": {
[7m [0m [91m    ~~~~~~~~~~~~~~~~~[0m
...
Errors  Files
     ...
     1  tests/tluaconfig.json[90m:7[0m
...
{"version":"FakeTSVersion","root":[2],"fileNames":["lib.luajit.d.tlua","./index.tlua"],"fileInfos":[{"version":"d4695a71643e88fc868e824886bcb416-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare console: { log(msg: any): void; };\ndeclare function require(module: string): any;","affectsGlobalScope":true,"impliedNodeFormat":1},"83d3733a851c98511df99803d53b0730-local c = require('core.index');\nlocal logic = require('logic.index');\n\nc.leftPad(\"\", 10);\nlogic.getSecondsInDay();\n\nlocal mod = require('core.anotherModule');\nreturn { m = mod };"],"options":{"composite":true,"declaration":true,"rootDir":"..","skipDefaultLibCheck":true,"target":1},"semanticDiagnosticsPerFile":[1,2],"emitDiagnosticsPerFile":[[2,[{"end":5,"code":100054,"category":1,"messageKey":"Declaration_emit_is_not_supported_for_a_Lua_module_yet_100054"}]]],"emitSignatures":[2]}
...
*not cached* /user/username/projects/sample1/tests/index.tlua
Signatures::


Edit [0]:: change extended file
//// [/user/username/projects/sample1/tests/tluaconfig.base.json] *modified* 
{
    "compilerOptions": { }
}
