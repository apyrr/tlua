...
//// [/user/username/projects/sample1/logic/tluaconfig.tluabuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    {
      "fileName": "./index.tlua",
      "version": "f863211ba2e71daf08f15c6d33708a6b-local c = require('core.index');\nfunction getSecondsInDay() {\n    return c.muitply();\n}\nlocal mod = require('core.anotherModule');\nreturn { getSecondsInDay = getSecondsInDay, m = mod };",
      "signature": "f863211ba2e71daf08f15c6d33708a6b-local c = require('core.index');\nfunction getSecondsInDay() {\n    return c.muitply();\n}\nlocal mod = require('core.anotherModule');\nreturn { getSecondsInDay = getSecondsInDay, m = mod };",
      "impliedNodeFormat": "CommonJS"
    }
  ],
  "options": {
