...
//// [/user/username/projects/sample1/logic/tluaconfig.tluabuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    {
      "fileName": "./index.tlua",
      "version": "46af8575f81293a590e07644df028fe0-local c = require('core.index');\nfunction getSecondsInDay()\n    return c.muitply();\nend\nlocal mod = require('core.anotherModule');\nreturn { getSecondsInDay = getSecondsInDay, m = mod };",
      "signature": "46af8575f81293a590e07644df028fe0-local c = require('core.index');\nfunction getSecondsInDay()\n    return c.muitply();\nend\nlocal mod = require('core.anotherModule');\nreturn { getSecondsInDay = getSecondsInDay, m = mod };",
      "impliedNodeFormat": "CommonJS"
    }
  ],
  "options": {
