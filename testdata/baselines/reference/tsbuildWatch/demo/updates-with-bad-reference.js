...
[[90mHH:MM:SS AM[0m] Project 'core/tsconfig.json' is out of date because output file 'lib/core/core/tsconfig.tsbuildinfo' does not exist

[[90mHH:MM:SS AM[0m] Building project 'core/tsconfig.json'...

[96manimals/dog.tlua[0m:[93m1[0m:[93m1[0m - [91merror[0m[90m TS100054: [0mDeclaration emit is not supported for a Lua module yet.

[7m1[0m local utilities = require('core.utilities');
[7m [0m [91m~~~~~[0m

[96manimals/dog.tlua[0m:[93m10[0m:[93m13[0m - [91merror[0m[90m TS1005: [0m',' expected.

[7m10[0m         size: "medium",
[7m  [0m [91m            ~[0m

[96manimals/dog.tlua[0m:[93m11[0m:[93m13[0m - [91merror[0m[90m TS1005: [0m',' expected.

[7m11[0m         woof: function()
[7m  [0m [91m            ~[0m

[96manimals/dog.tlua[0m:[93m14[0m:[93m13[0m - [91merror[0m[90m TS1005: [0m',' expected.

[7m14[0m         name: utilities.makeRandomName()
[7m  [0m [91m            ~[0m

[96manimals/index.tlua[0m:[93m1[0m:[93m1[0m - [91merror[0m[90m TS100054: [0mDeclaration emit is not supported for a Lua module yet.

[7m1[0m local dog = require('animals.dog');
[7m [0m [91m~~~~~[0m

[96mcore/utilities.tlua[0m:[93m1[0m:[93m1[0m - [91merror[0m[90m TS100054: [0mDeclaration emit is not supported for a Lua module yet.

[7m1[0m local A = require('animals.index');
[7m [0m [91m~~~~~[0m

[[90mHH:MM:SS AM[0m] Project 'animals/tsconfig.json' is out of date because output file 'lib/animals/animals/tsconfig.tsbuildinfo' does not exist

[[90mHH:MM:SS AM[0m] Building project 'animals/tsconfig.json'...

[96manimals/animal.tlua[0m:[93m1[0m:[93m1[0m - [91merror[0m[90m TS100054: [0mDeclaration emit is not supported for a Lua module yet.
...
[[90mHH:MM:SS AM[0m] Project 'zoo/tsconfig.json' is out of date because output file 'lib/zoo/zoo/tsconfig.tsbuildinfo' does not exist
...
[96mzoo/zoo.tlua[0m:[93m1[0m:[93m1[0m - [91merror[0m[90m TS100054: [0mDeclaration emit is not supported for a Lua module yet.
...
//// [/user/username/projects/demo/lib/animals/animals/tsconfig.tsbuildinfo] *new* 
...
//// [/user/username/projects/demo/lib/animals/animals/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
...
//// [/user/username/projects/demo/lib/core/core/tsconfig.tsbuildinfo] *new* 
...
//// [/user/username/projects/demo/lib/core/core/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  "version": "FakeTSVersion",
  "root": [
    {
...
//// [/user/username/projects/demo/lib/zoo/zoo/tsconfig.tsbuildinfo] *new* 
...
//// [/user/username/projects/demo/lib/zoo/zoo/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  "version": "FakeTSVersion",
  "root": [
    {
...
[[90mHH:MM:SS AM[0m] Project 'core/tsconfig.json' is out of date because buildinfo file 'lib/core/core/tsconfig.tsbuildinfo' indicates that program needs to report errors.
...
[96mcore/utilities.tlua[0m:[93m2[0m:[93m1[0m - [91merror[0m[90m TS100054: [0mDeclaration emit is not supported for a Lua module yet.

[7m2[0m local A = require('animals.index');
[7m [0m [91m~~~~~[0m

[[90mHH:MM:SS AM[0m] Project 'animals/tsconfig.json' is out of date because it has errors.
...
[[90mHH:MM:SS AM[0m] Updating unchanged output timestamps of project 'animals/tsconfig.json'...

[[90mHH:MM:SS AM[0m] Project 'zoo/tsconfig.json' is out of date because it has errors.
...
//// [/user/username/projects/demo/lib/core/core/tsconfig.tsbuildinfo.readable.baseline.txt] *modified* 
{
  ...
  "fileInfos": [
    ...
    {
      "fileName": "../../../core/utilities.tlua",
      "version": "f2c3a1ee5167c8efe4d8bdac84e23903-\nlocal A = require('animals.index');\nA;\nfunction makeRandomName() {\n    return \"Bob!?! \";\n}\n\nfunction lastElementOf<T>(arr: T[]): T | undefined {\n    if (arr.length == 0) return undefined;\n    return arr[arr.length - 1];\n}\n\nreturn { makeRandomName = makeRandomName, lastElementOf = lastElementOf };",
...
//// [/user/username/projects/demo/lib/zoo/zoo/tsconfig.tsbuildinfo] *mTime changed*
