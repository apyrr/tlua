...
[[90mHH:MM:SS AM[0m] Project 'tluaconfig.json' is up to date but needs to update timestamps of output files that are older than input files

[[90mHH:MM:SS AM[0m] Updating output timestamps of project 'tluaconfig.json'...

[[90mHH:MM:SS AM[0m] Found 0 errors. Watching for file changes.

//// [/user/username/projects/noEmitOnError/dev-build/tluaconfig.tluabuildinfo] *mTime changed*
...
[[90mHH:MM:SS AM[0m] Project 'tluaconfig.json' is out of date because output 'dev-build/tluaconfig.tluabuildinfo' is older than input 'src/main.tlua'
