...
[[90mHH:MM:SS AM[0m] Project 'core/tluaconfig.json' is out of date because output file 'core/outDir/tluaconfig.tluabuildinfo' does not exist
...
//// [/user/username/projects/sample1/core/outDir/anotherModule.lua] *new* 
local World = "hello";
return { World = World };
...
[[90mHH:MM:SS AM[0m] Project 'core/tluaconfig.json' is out of date because buildinfo file 'core/outDir/tluaconfig.tluabuildinfo' indicates that program needs to report errors.
...
//// [/user/username/projects/sample1/core/outDir/file3.lua] *new* 
local y = 10;
