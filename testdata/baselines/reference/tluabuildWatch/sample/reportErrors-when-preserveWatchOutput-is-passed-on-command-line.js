...
tlua -b -w tests --preserveWatchOutput
...
[7m1[0m local y: string = 10;
[7m [0m [91m~~~~~[0m

[96mlogic/index.tlua[0m:[93m1[0m:[93m7[0m - [91merror[0m[90m TLUA2322: [0mType 'number' is not assignable to type 'string'.
...
//// [/user/username/projects/sample1/logic/tluaconfig.tluabuildinfo.readable.baseline.txt] *modified* 
{
  ...
  "fileInfos": [
    ...
    {
      "fileName": "./index.tlua",
      "version": "3336724be9338f8de5bb2175d9ee08e3-local y: string = 10;\nlocal c = require('core.index');\nfunction getSecondsInDay() {\n    return c.multiply(10, 15);\n}\nlocal mod = require('core.anotherModule');\nreturn { getSecondsInDay = getSecondsInDay, m = mod };",
...
[7m1[0m local x: string = 10;
[7m [0m [91m~~~~~[0m

[96mcore/index.tlua[0m:[93m1[0m:[93m7[0m - [91merror[0m[90m TLUA2322: [0mType 'number' is not assignable to type 'string'.
...
//// [/user/username/projects/sample1/core/tluaconfig.tluabuildinfo.readable.baseline.txt] *modified* 
{
  ...
  "fileInfos": [
    ...
    {
      "fileName": "./index.tlua",
      "version": "981f67e8c574cfe8d75110c0ec1c394a-local x: string = 10;\nlocal someString: string = \"HELLO WORLD\";\nfunction leftPad(s: string, n: number) { return s + n; }\nfunction multiply(a: number, b: number) { return a * b; }\nreturn { someString = someString, leftPad = leftPad, multiply = multiply };",
      "signature": "59f451fde7dea7b84d390cf390374c8b-\n(0,5): error100054: Declaration_emit_is_not_supported_for_a_Lua_module_yet_100054\n",
      "impliedNodeFormat": "CommonJS",
      "original": {
        "version": "981f67e8c574cfe8d75110c0ec1c394a-local x: string = 10;\nlocal someString: string = \"HELLO WORLD\";\nfunction leftPad(s: string, n: number) { return s + n; }\nfunction multiply(a: number, b: number) { return a * b; }\nreturn { someString = someString, leftPad = leftPad, multiply = multiply };",
