...
//// [/user/username/projects/demo/lib/core/core/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "version": "fb8cf30289b0fcddabc142618975eab2-function makeRandomName() {\n    return \"Bob!?! \";\n}\n\nfunction lastElementOf<T>(arr: T[]): T | undefined {\n    if (arr.length == 0) return undefined;\n    return arr[arr.length - 1];\n}\n\nreturn { makeRandomName = makeRandomName, lastElementOf = lastElementOf };",
      "signature": "fb8cf30289b0fcddabc142618975eab2-function makeRandomName() {\n    return \"Bob!?! \";\n}\n\nfunction lastElementOf<T>(arr: T[]): T | undefined {\n    if (arr.length == 0) return undefined;\n    return arr[arr.length - 1];\n}\n\nreturn { makeRandomName = makeRandomName, lastElementOf = lastElementOf };",
      "impliedNodeFormat": "CommonJS"
    }
  ],
  "options": {
...
[[90mHH:MM:SS AM[0m] Project 'animals/tsconfig.json' is out of date because buildinfo file 'lib/animals/animals/tsconfig.tsbuildinfo' indicates that program needs to report errors.
...
[[90mHH:MM:SS AM[0m] Project 'zoo/tsconfig.json' is out of date because buildinfo file 'lib/zoo/zoo/tsconfig.tsbuildinfo' indicates that program needs to report errors.
