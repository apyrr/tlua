...
local mod = require('core.anotherModule');
return { m = mod };
//// [/user/username/projects/sample1/tests/tsconfig.base.json] *new* 
{
    "compilerOptions": {
        "target": "es5"
    }
...
[96mtests/tsconfig.json[0m:[93m7[0m:[93m5[0m - [91merror[0m[90m TS5108: [0mOption 'target=ES5' has been removed. Please remove it from your configuration.
...
Errors  Files
     ...
     1  tests/tsconfig.json[90m:7[0m
...
//// [/user/username/projects/sample1/tests/tsconfig.base.json] *modified* 
{
    "compilerOptions": { }
}
