...
Input::
//// [/home/src/workspaces/project/node_modules/my-dep/init.tlua] *new* 
...
//// [/home/src/workspaces/project/dist/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    {
      "fileName": "../node_modules/my-dep/init.tlua",
...
*refresh*    /home/src/workspaces/project/node_modules/my-dep/init.tlua
...
Edit [1]:: update dependency module with breaking type change
//// [/home/src/workspaces/project/node_modules/my-dep/init.tlua] *modified* 
...
*refresh*    /home/src/workspaces/project/node_modules/my-dep/init.tlua
Signatures::
(used version)   /home/src/workspaces/project/node_modules/my-dep/init.tlua
...
Edit [2]:: restore dependency module
//// [/home/src/workspaces/project/node_modules/my-dep/init.tlua] *modified* 
local myValue: string = "";
return { myValue = myValue };
...
Edit [3]:: update dependency module timestamp without changing text
//// [/home/src/workspaces/project/node_modules/my-dep/init.tlua] *mTime changed*
...
Edit [5]:: delete dependency module
//// [/home/src/workspaces/project/node_modules/my-dep/init.tlua] *deleted*
...
//// [/home/src/workspaces/project/dist/tsconfig.tsbuildinfo] *modified* 
{"version":"FakeTSVersion","root":[2],"packageJsons":["../node_modules/my-dep/package.json"],"fileNames":["lib.luajit.d.tlua","../src/index.tlua"],"fileInfos":[{"version":"d4695a71643e88fc868e824886bcb416-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare console: { log(msg: any): void; };\ndeclare function require(module: string): any;","affectsGlobalScope":true,"impliedNodeFormat":1},"9d1eaa60483e57370e19e23fdca9b979-local myDep = require(\"my-dep\");\nlocal value: string = myDep.myValue;"],"options":{"composite":true,"outDir":"./","strict":true},"emitDiagnosticsPerFile":[[2,[{"end":5,"code":100054,"category":1,"messageKey":"Declaration_emit_is_not_supported_for_a_Lua_module_yet_100054"}]]],"emitSignatures":[2]}
//// [/home/src/workspaces/project/dist/tsconfig.tsbuildinfo.readable.baseline.txt] *modified* 
{
  "version": "FakeTSVersion",
  "root": [
