...
const testFile = resolve(repoRoot, "testdata/tests/cases/astnav/mapCode.tlua");
...
describe("astnav", () => {
    ...
    before(async () => {
        ...
        const sf = await project.program.getSourceFile("/src/testFile.tlua");
