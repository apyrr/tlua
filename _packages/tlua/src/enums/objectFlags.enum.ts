...
export enum ObjectFlags {
    ...
    Metatable = 1 << 31,
    ObjectTypeKindMask = ClassOrInterface | Reference | Tuple | Anonymous | Mapped | ReverseMapped | EvolvingArray | InstantiationExpressionType | SingleSignatureType | Metatable,
    ContainsSpread = 1 << 22,
    ObjectRestType = 1 << 23,
