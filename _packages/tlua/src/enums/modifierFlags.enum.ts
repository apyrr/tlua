...
export enum ModifierFlags {
    ...
    SyntacticOnlyModifiers = Export | Ambient | Abstract | Static | Accessor | Suspend | Default | Const | In | Out,
    ...
    All = Export | Ambient | Public | Private | Protected | Static | Readonly | Abstract | Accessor | Suspend | Default | Const | Deprecated | Override | In | Out,
    JavaScript = Export | Static | Accessor | Suspend | Default,
}
