...
export enum ModifierFlags {
    ...
    SyntacticOnlyModifiers = Export | Ambient | Abstract | Static | Accessor | Async | Default | In | Out,
    ...
    All = Export | Ambient | Public | Private | Protected | Static | Readonly | Abstract | Accessor | Async | Default | Deprecated | Override | In | Out,
