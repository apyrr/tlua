...
export function isExpression(node: Node): node is Expression {
    ...
    return kind === SyntaxKind.ConditionalExpression
        ...
        || kind === SyntaxKind.VarargExpression
        || kind === SyntaxKind.ExpressionWithTypeArguments;
}
...
export function isLiteralTypeLiteral(node: Node): node is NilLiteral | BooleanLiteral | LiteralExpression | PrefixUnaryExpression {
    const kind = node.kind;
    return kind === SyntaxKind.NilKeyword || kind === SyntaxKind.TrueKeyword
