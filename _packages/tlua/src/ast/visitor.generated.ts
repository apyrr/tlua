...
const visitEachChildTable: Record<number, VisitEachChildFunction> = {
    ...
    [SyntaxKind.RepeatStatement]: (node: RepeatStatement, visitor: Visitor): RepeatStatement => {
        ...
        const _expression = visitNode(node.expression, visitor, isExpression);
        return updateRepeatStatement(node, _statements, _expression);
    },
    ...
    [SyntaxKind.LabelStatement]: (node: LabelStatement, visitor: Visitor): LabelStatement => {
        ...
        return updateLabelStatement(node, _label);
    },
    [SyntaxKind.GotoStatement]: (node: GotoStatement, visitor: Visitor): GotoStatement => {
        const _label = visitNode(node.label, visitor, isIdentifier);
        return updateGotoStatement(node, _label);
    },
    ...
    [SyntaxKind.FunctionDeclaration]: (node: FunctionDeclaration, visitor: Visitor): FunctionDeclaration => {
        const _modifiers = visitNodes(node.modifiers, visitor);
        const _target = visitNode(node.target, visitor, isExpression);
    ...
    [SyntaxKind.FunctionExpression]: (node: FunctionExpression, visitor: Visitor): FunctionExpression => {
        ...
        const _type = visitNode(node.type, visitor, isTypeNode);
        const _body = visitNode(node.body, visitor, isFunctionBody);
        return updateFunctionExpression(node, _modifiers, _name, _typeParameters, _parameters, _type, _body);
    },
    ...
    [SyntaxKind.TableEntry]: (node: TableEntry, visitor: Visitor): TableEntry => {
        const _expression = visitNode(node.expression, visitor, isExpression);
        return updateTableEntry(node, _expression);
    },
    ...
    [SyntaxKind.MultiReturnType]: (node: MultiReturnTypeNode, visitor: Visitor): MultiReturnTypeNode => {
        const _elements = visitNodes(node.elements, visitor);
        return updateMultiReturnTypeNode(node, _elements);
    },
    ...
    [SyntaxKind.TypeParameter]: (node: TypeParameterDeclaration, visitor: Visitor): TypeParameterDeclaration => {
        ...
        return updateTypeParameterDeclaration(node, _modifiers, _dotDotDotToken, _name, _constraint, _expression, _defaultType);
    },
