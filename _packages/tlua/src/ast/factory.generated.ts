...
function cloneNodeData(node: Node): any {
    ...
    switch (node.kind) {
        ...
        case SyntaxKind.NumericForStatement:
            return { initializer: n.initializer, from: n.from, to: n.to, step: n.step, statement: n.statement };
        ...
        case SyntaxKind.RestType:
            return { type: n.type };
        case SyntaxKind.MultiReturnType:
            return { elements: n.elements };
        ...
        case SyntaxKind.TypeParameter:
            return { modifiers: n.modifiers, dotDotDotToken: n.dotDotDotToken, name: n.name, constraint: n.constraint, expression: n.expression, defaultType: n.defaultType };
...
const forEachChildTable: Record<number, ForEachChildFunction> = {
    ...
    [SyntaxKind.ForOfStatement]: (data, cbNode, cbNodes) =>
        ...
        visitNode(cbNode, data.expression) ||
        visitNode(cbNode, data.statement),
    [SyntaxKind.NumericForStatement]: (data, cbNode, cbNodes) =>
        visitNode(cbNode, data.initializer) ||
        visitNode(cbNode, data.from) ||
        visitNode(cbNode, data.to) ||
        visitNode(cbNode, data.step) ||
        visitNode(cbNode, data.statement),
    [SyntaxKind.RepeatStatement]: (data, cbNode, cbNodes) =>
    ...
    [SyntaxKind.TableEntry]: (data, cbNode, cbNodes) => visitNode(cbNode, data.expression),
...
export function createNumericForStatement(initializer: ForInitializer, from: Expression, to: Expression, step: Expression | undefined, statement: Block): NumericForStatement {
    return new NodeObject(SyntaxKind.NumericForStatement, {
        ...
        step,
        statement,
    }) as unknown as NumericForStatement;
}

export function createRepeatStatement(statements: readonly Statement[], expression: Expression): RepeatStatement {
    return new NodeObject(SyntaxKind.RepeatStatement, {
        statements: createNodeArray(statements),
        expression,
    }) as unknown as RepeatStatement;
}

export function createBreakStatement(): BreakStatement {
    return new NodeObject(SyntaxKind.BreakStatement, undefined) as unknown as BreakStatement;
}

export function createContinueStatement(): ContinueStatement {
    return new NodeObject(SyntaxKind.ContinueStatement, undefined) as unknown as ContinueStatement;
}
...
export function createLabelStatement(label: Identifier): LabelStatement {
    return new NodeObject(SyntaxKind.LabelStatement, {
        label,
    }) as unknown as LabelStatement;
}

export function createGotoStatement(label: Identifier): GotoStatement {
    return new NodeObject(SyntaxKind.GotoStatement, {
        label,
    }) as unknown as GotoStatement;
}
...
export function createFunctionDeclaration(modifiers: readonly ModifierLike[] | undefined, target: Expression | undefined, colonToken: ColonToken | undefined, name: Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type?: TypeNode, body?: FunctionBody): FunctionDeclaration {
...
export function createPrefixUnaryExpression(operator: SyntaxKind.PlusToken | SyntaxKind.MinusToken | SyntaxKind.ExclamationToken | SyntaxKind.HashToken, operand: Expression): PrefixUnaryExpression {
...
export function createFunctionExpression(modifiers: readonly ModifierLike[] | undefined, name: Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: FunctionBody): FunctionExpression {
...
export function createExpressionList(elements: readonly Expression[]): ExpressionList {
    return new NodeObject(SyntaxKind.ExpressionList, {
        elements: createNodeArray(elements),
    }) as unknown as ExpressionList;
}
...
export function createTableEntry(expression: Expression): TableEntry {
    return new NodeObject(SyntaxKind.TableEntry, {
        expression,
...
export function createMultiReturnTypeNode(elements: readonly TypeNode[]): MultiReturnTypeNode {
    return new NodeObject(SyntaxKind.MultiReturnType, {
        elements: createNodeArray(elements),
    }) as unknown as MultiReturnTypeNode;
}
...
export function createFunctionTypeNode(modifiers: readonly ModifierLike[] | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type?: TypeNode): FunctionTypeNode {
...
export function createTypeParameterDeclaration(modifiers: readonly ModifierLike[] | undefined, dotDotDotToken: DotDotDotToken | undefined, name: Identifier, constraint?: TypeNode, expression?: Expression, defaultType?: TypeNode): TypeParameterDeclaration {
...
export function updateRepeatStatement(node: RepeatStatement, statements: readonly Statement[], expression: Expression): RepeatStatement {
    return node.statements !== statements || node.expression !== expression ? createRepeatStatement(statements, expression) : node;
}
...
export function updateGotoStatement(node: GotoStatement, label: Identifier): GotoStatement {
    return node.label !== label ? createGotoStatement(label) : node;
}
...
export function updateFunctionDeclaration(node: FunctionDeclaration, modifiers: readonly ModifierLike[] | undefined, target: Expression | undefined, colonToken: ColonToken | undefined, name: Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type?: TypeNode, body?: FunctionBody): FunctionDeclaration {
...
export function updateFunctionExpression(node: FunctionExpression, modifiers: readonly ModifierLike[] | undefined, name: Identifier | undefined, typeParameters: readonly TypeParameterDeclaration[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined, body: FunctionBody): FunctionExpression {
    return node.modifiers !== modifiers || node.name !== name || node.typeParameters !== typeParameters || node.parameters !== parameters || node.type !== type || node.body !== body ? createFunctionExpression(modifiers, name, typeParameters, parameters, type, body) : node;
}
...
export function updateTableEntry(node: TableEntry, expression: Expression): TableEntry {
    return node.expression !== expression ? createTableEntry(expression) : node;
}
...
export function updateMultiReturnTypeNode(node: MultiReturnTypeNode, elements: readonly TypeNode[]): MultiReturnTypeNode {
    return node.elements !== elements ? createMultiReturnTypeNode(elements) : node;
}
...
export function updateTypeParameterDeclaration(node: TypeParameterDeclaration, modifiers: readonly ModifierLike[] | undefined, dotDotDotToken: DotDotDotToken | undefined, name: Identifier, constraint?: TypeNode, expression?: Expression, defaultType?: TypeNode): TypeParameterDeclaration {
    return node.modifiers !== modifiers || node.dotDotDotToken !== dotDotDotToken || node.name !== name || node.constraint !== constraint || node.expression !== expression || node.defaultType !== defaultType ? createTypeParameterDeclaration(modifiers, dotDotDotToken, name, constraint, expression, defaultType) : node;
}
