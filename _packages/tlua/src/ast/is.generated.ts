...
export function isExpressionList(node: Node): node is ExpressionList {
    return node.kind === SyntaxKind.ExpressionList;
}
...
export function isTableEntry(node: Node): node is TableEntry {
    return node.kind === SyntaxKind.TableEntry;
}
...
export function isMultiReturnTypeNode(node: Node): node is MultiReturnTypeNode {
    return node.kind === SyntaxKind.MultiReturnType;
}
...
export function isDeclarationName(node: Node): node is DeclarationName {
    ...
    return kind === SyntaxKind.Identifier || kind === SyntaxKind.PrivateIdentifier || kind === SyntaxKind.StringLiteral || kind === SyntaxKind.NumericLiteral || kind === SyntaxKind.NoSubstitutionTemplateLiteral || kind === SyntaxKind.ComputedPropertyName || kind === SyntaxKind.ObjectBindingPattern || kind === SyntaxKind.ArrayBindingPattern || kind === SyntaxKind.ElementAccessExpression;
}
...
export function isPropertyName(node: Node): node is PropertyName {
    const kind = node.kind;
    return kind === SyntaxKind.Identifier || kind === SyntaxKind.StringLiteral || kind === SyntaxKind.NoSubstitutionTemplateLiteral || kind === SyntaxKind.NumericLiteral || kind === SyntaxKind.ComputedPropertyName || kind === SyntaxKind.PrivateIdentifier;
}
...
export function isLiteralExpression(node: Node): node is LiteralExpression {
    const kind = node.kind;
    return kind === SyntaxKind.StringLiteral || kind === SyntaxKind.NumericLiteral || kind === SyntaxKind.RegularExpressionLiteral || kind === SyntaxKind.NoSubstitutionTemplateLiteral;
}
...
export function isKeywordExpressionKind(kind: SyntaxKind): kind is KeywordExpressionSyntaxKind {
    return kind === SyntaxKind.NilKeyword
...
export function isConcatenationOperator(kind: SyntaxKind): kind is ConcatenationOperator {
    return kind === SyntaxKind.DotDotToken;
}

export function isConcatenationOperatorOrHigher(kind: SyntaxKind): kind is ConcatenationOperatorOrHigher {
    return isAdditiveOperatorOrHigher(kind)
        || isConcatenationOperator(kind);
}
...
export function isRelationalOperatorOrHigher(kind: SyntaxKind): kind is RelationalOperatorOrHigher {
    return isConcatenationOperatorOrHigher(kind)
