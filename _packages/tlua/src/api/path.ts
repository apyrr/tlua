 ...
 * fileNameToDocumentURI("^/vscode-vfs/github/apyrr/tlua/file.ts") === "vscode-vfs://github/apyrr/tlua/file.ts"
 */
 ...
 * documentURIToFileName("vscode-vfs://github/apyrr/tlua/file.ts") === "^/vscode-vfs/github/apyrr/tlua/file.ts"
 */
