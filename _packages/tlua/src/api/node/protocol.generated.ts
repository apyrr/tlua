...
export const childProperties: Readonly<Partial<Record<SyntaxKind, readonly (string | undefined)[]>>> = {
    ...
    [SyntaxKind.ImportDeclaration]: ["modifiers", "importClause", "moduleSpecifier"],
    [SyntaxKind.JSImportDeclaration]: ["modifiers", "importClause", "moduleSpecifier"],
    ...
    [SyntaxKind.JSDocImportTag]: ["tagName", "importClause", "moduleSpecifier", "comment"],
    ...
    [SyntaxKind.ExportDeclaration]: ["modifiers", "exportClause", "moduleSpecifier"],
    [SyntaxKind.ImportType]: ["argument", "qualifier", "typeArguments"],
