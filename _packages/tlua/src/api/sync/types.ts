...
/**
 * Freshable literal types (TypeFlags.Freshable and TypeFlags.Literal).
 */
...
/** Literal types: StringLiteral, NumberLiteral, BooleanLiteral */
...
/** Intrinsic types — any, unknown, string, number, symbol, void, undefined, null, never, object (TypeFlags.Intrinsic) */
...
/** A type predicate — e.g. `x is T` or `asserts x is T`; the `this`-based forms are removed with the `this` type */
...
/**
 * A diagnostic message from the tlua compiler.
 */
